...
namespace SpcBowling.Controllers
{
    ...
    public class UsersAdminController : Controller
    {
        ...
        public async Task<ActionResult> Create()
        {
            ...
            ViewBag.RoleId = new SelectList(await RoleManager.Roles.OrderBy(n=>n.Name).ToListAsync(), "Name", "Name");
        ...
        public async Task<ActionResult> Create(RegisterViewModel userViewModel, params string[] selectedRoles)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser
                {
                    ...
                    //PlayerID = userViewModel.PlayerID,
        ...
        public async Task<ActionResult> Edit(string id)
        {
            ...
            return View(new EditUserViewModel()
            {
                ...
                RolesList = RoleManager.Roles.OrderBy(n=>n.Name).ToList().Select(x => new SelectListItem()
                {
        ...
        public async Task<ActionResult> Edit([Bind(Include = "Email,Id,Address,City,State,PostalCode")] EditUserViewModel editUser, params string[] selectedRole)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //user.PlayerID = editUser.PlayerID;
